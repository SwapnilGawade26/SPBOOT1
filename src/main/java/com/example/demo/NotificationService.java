...
public class NotificationService {
	 ...
	 * 
	 * // sets SMTP server properties Properties properties = new Properties();
	 ...
	 * 
	 * msg.setFrom(new InternetAddress(USERNAME)); // System.out.println(toAddress);
	 * String[] str = toAddress.split(","); for (String string : str) { //
	 * System.out.println(string); InternetAddress[] toAddresses = { new
	 * InternetAddress(string) };
	 * 
	 * msg.setRecipients(Message.RecipientType.TO, toAddresses);
	 * msg.setSubject(subject); msg.setSentDate(new Date()); // set plain text
	 * message msg.setContent(message, "text/html");
	 * 
